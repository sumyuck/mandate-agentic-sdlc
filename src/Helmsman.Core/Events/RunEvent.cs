...
public sealed record RunEvent
{
        ...
        TPayload payload)
    {
        ...
        string payloadJson = JsonSerializer.Serialize(payload, HelmsmanJson.Canonical);
    ...
    public TPayload Payload<TPayload>() =>
        JsonSerializer.Deserialize<TPayload>(PayloadJson, HelmsmanJson.Canonical)
        ...
        Sha256Hash previousHash)
    {
        ...
        return Sha256Hash.OfUtf8(JsonSerializer.Serialize(preimage, HelmsmanJson.Canonical));
    }
